...
//	
//		SQL DB wrapper utilities source file
//
...
*/
int sqldb_last_insert_rowid(sqldb *db)
{
...
** directly.
**
** As of sqlite3, this is no longer needed! Still provided for backwards compatibility...
*/
...
{
	return sqlite3_encode_binary(in, n, out);
}
...
{
	return sqlite3_decode_binary(in, out);
}
