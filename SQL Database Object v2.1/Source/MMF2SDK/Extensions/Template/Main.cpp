...
{
	//IntFloat will be a placeholder for the float to return through.
	long IntoFloat;
	...
	//Move the float into the long placeholder.
	memcpy((void *)&IntoFloat,(void *)&fp1,sizeof(float));
	
	//Now we can return the Float safely.
	return((long)IntoFloat);
